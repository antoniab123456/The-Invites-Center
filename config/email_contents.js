...
let message = {
    emailVerification: (token) => { 
        let contents = {
            ...
            text: `Click on the link to confirm your email: http://localhost:3000/users/verify?token=${token}!`,
        }
    ...
    forgotPassword: (token) => {
        let contents = {
                ...
                Please, follow the link to reset your password: http://localhost:3000/users/change_pass?token=${token}
